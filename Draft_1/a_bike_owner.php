...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    $sql = "SELECT vehicle_id,user_id,advert_title,description,bike_model,bike_lower_price,bike_upper_price,bike_quality,bike_mileage,manufacture_year,num_seats,other_media_url,colour,image_url,is_electric FROM bike_details WHERE vehicle_id = ?";
    ...
    <article>
            ...
            <div id="navbarWrapper">
                <nav>
                    <ul>
                        ...
                        <li><a href="./my_account.php"><img src="./assets/icons/3994415_account_avatar_person_profile_user_icon.png" />My
                                Account</a></li>
                        <li><a href="./rent_out.php"><img src="./assets/icons/4634978_pig_coin_financial_money_icon.png" />Rent out!</a>
                        </li>
                        ...
                        <li id="logout_button"><a href="./logout.php"><img src="./assets/icons/2931185_door_enter_exit_leave_out_icon(1).png" />Logout</a>
                        </li>
                    </ul>
                </nav>
                ...
                <div class="row">
                    ...
                    <div class='right-column'>
                        <div class="main_body_container">
                            ...
                            <form id="sell_form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="post" enctype="multipart/form-data">
                                <input readonly id="bike_id" name="bike_id" value="<?php if ($_SERVER["REQUEST_METHOD"] == "GET") {
                                                                                        echo $_GET["id"];
                                ...
                                <div class="form_main">
                                    ...
                                    <div class="input_row">
                                        <div class="input_col" id="title_container">
                                            ...
                                            <div id="advert_title_container">
                                                ...
                                                <div id="ad_title_error_div" class="error_div">
                                                    <p><?php echo $ad_title_error; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input_row" id="input_row_for_bike_image">
                                        <div class="input_col" id="bike_image_column">
                                            ...
                                            <div id="bike_image_error_div" class="error_div">
                                                <p><?php echo $bike_photo_error; ?></p>
                                            </div>
                                            <p id="price_range">Rent it for between <b>£<span id="lower_price"><?php echo $page_bike_lower_price; ?></span></b>
                                    ...
                                    <div class="input_row">
                                        <div class="input_col" id="bike_desc_col">
                                            ...
                                            <div class="bike_desc">
                                                ...
                                                <div id="bike_desc_error" class="error_div">
                                                    <p><?php echo $bike_bio_error; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input_row">
                                        <div class="input_col" id="bike_model_col">
                                            ...
                                            <div class="bike_model_container">
                                                ...
                                                <div id="bike_model_error_div" class="error_div">
                                                    <p><?php echo $bike_model_error; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="input_row" style="display: none;" id="price_row">
                                        <div class="input_col">
                                            ...
                                            <input type="number" min="50" max="10000" placeholder="1000" step="10" id="asking_price_lower" name="asking_price_lower" autocomplete="off" readonly value="<?php echo $page_bike_lower_price; ?>"></input>
                                            <div id="lower_price_error_div" class="error_div">
                                                <p><?php echo $asking_price_lower_error; ?></p>
                                            </div>
                                        ...
                                        <div class="input_col">
                                            ...
                                            <input type="number" min="50" max="10000" placeholder="2000" step="10" id="asking_price_upper" name="asking_price_upper" autocomplete="off" readonly value="<?php echo $page_bike_upper_price; ?>"></input>
                                            <div id="upper_price_error_div" class="error_div">
                                                <p><?php echo $asking_price_upper_error; ?></p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input_row">
                                        <div class="input_col">
                                            <label for="bike_quality">Bike quality: <span id="bike_slider_value">Ok</span></label>
                                            <input id="bike_quality" autocomplete="off" type="range" min="0" max="5" step="1" value=<?php echo $page_bike_quality; ?> class="slider" name="bike_quality" disabled></input>
                                            <div id="bike_quality_error_div" class="error_div">
                                                <p><?php echo $bike_quality_error; ?></p>
                                            </div>
                                        ...
                                        <div class="input_col" id="bike_birthday_col">
                                            ...
                                            <div class="bike_birthday_container">
                                                ...
                                                <div id="bike_date_of_birth_error" class="error_div">
                                                    <p><?php echo $bike_date_of_birth_error; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input_row">
                                        <div class="input_col">
                                            ...
                                            <input id="bike_mileage" autocomplete="off" type="range" min="0" max="1100" step="100" value=<?php echo $page_bike_mileage; ?> class="slider" name="bike_mileage" disabled></input>
                                            <div id="bike_mileage_error_div" class="error_div">
                                                <p><?php echo $bike_mileage_error; ?></p>
                                            </div>
                                        ...
                                        <div class="input_col" id="seat_col">
                                            ...
                                            <div class="seat_container">
                                                ...
                                                <div id="bike_seats_error_div" class="error_div">
                                                    <p><?php echo $bike_seats_error; ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="input_row">
                                        ...
                                        <div class="input_col" id="FaveColourBike">
                                            ...
                                            <input type="color" value="<?php echo $page_colour; ?>" id="favourite_bike_colour" autocomplete="off" name="favourite_bike_colour" autocomplete="off" disabled></input>
                                            <div id="favourite_bike_colour_error" class="error_div">
                                                <p><?php echo $bike_colour_error; ?></p>
                                            </div>
                                        </div>

                                        <div class="input_col" id="electric_row">
                                            <h2>Is the bike electric?</h2>
                                            <input id="is_electric" autocomplete="off" type="checkbox" disabled name="is_electric" <?php echo $page_is_electric; ?>><label for="is_electric"></label></input>
                                            <div id="bike_electric_error_div" class="error_div">
                                                <p><?php echo $is_bike_electric_error; ?></p>
                                            </div>
                                    ...
                                    <div class="input_row" id="other_media_row">
                                        ...
                                        <div class="input_col" id="other_media_column">
                                            ...
                                            ?>
                                            <div id="other_media_error" class="error_div">
                                                <p><?php echo $bike_other_media_error; ?></p>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="left-column">
                        ...
                        <br>
                        <div class="user_picture"><img src="<?php echo $page_profile_url; ?>" />
                        </div>
        ...
        <footer>
            <div class="social_media_row">
                ...
                <a href="https://twitter.com"><img src="./assets/icons/twitter.webp" id="twitter" /></a>

                <a href="https://instagram.com"><img src="./assets/icons/instagram-white-icon.webp" /></a>

                <a href="https://example.com"><img src="./assets/icons/tiktok.png" /></a>
                <a href="https://old.com"><img src="./assets/icons/facebook-icon-white-png.png" /></a>
